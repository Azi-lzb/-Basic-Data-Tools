...
rem conda run + PyInstaller 4 cannot reliably pass a Chinese spec filename.
set "SPEC_FILE=%CD%\packaging\specs\base_audit_win7_x86.spec"
...
"%CONDA_EXE%" run -n HZPBCwin7x86 python "packaging\scripts\finalize_win7_build.py" x86
