...
from .calculation import ENGINE_DEFAULT
...
def run_flow(*, flow_name: str, template_path: Path | None, input_dir: Path, output_dir: Path,
    ...
    try:
        ...
        # 条件格式是一个独立步骤：其自身“失败后处理”决定 UNO 缺失时是跳过还是中止整批。
