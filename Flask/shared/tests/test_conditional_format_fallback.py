...
The Windows edition reads a rendered conditional-format colour through
Excel/WPS ``DisplayFormat``.  WPS 12.0 returns ``None``, so the session falls
back to evaluating the submission's own OOXML rules.  These tests cover
